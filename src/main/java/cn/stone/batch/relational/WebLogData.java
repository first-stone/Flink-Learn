 ...
 * @Author: cn.stone
 * @Description:
 * @Date: Created in 10:18 2020/9/21
 * @Modified By:
 */
public class WebLogData {
    ...
    public static DataSet<Tuple2<String, String>> getDocumentDataSet(ExecutionEnvironment env) {
        ArrayList<Tuple2<String, String>> data = new ArrayList<Tuple2<String, String>>(100);
    ...
    public static DataSet<Tuple3<Integer, String, Integer>> getRankDataSet(ExecutionEnvironment env) {
        ArrayList<Tuple3<Integer, String, Integer>> data = new ArrayList<Tuple3<Integer, String, Integer>>(100);
        for (Object[] rank : RANKS) {
            data.add(new Tuple3<Integer, String, Integer>((Integer) rank[0], (String) rank[1], (Integer) rank[3]));
        }
        return env.fromCollection(data);
    }
